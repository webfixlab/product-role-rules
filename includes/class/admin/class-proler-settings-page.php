...
class Proler_Settings_Page {
	...
	/**
	 * Display settings page navigations
	 */
	...
	/**
	 * Addd plugin admin settings menu
	 */
	...
	/**
	 * Display settings submit button
	 */
	...
	/**
	 * Display create new role content
	 */
	...
	/**
	 * Display general settings field
	 *
	 * @param array $data Field data.
	 */
	...
	/**
	 * Display popup to notify pro features
	 *
	 * @param string $page_slug Current page slug.
	 */
	public static function pro_popup( $page_slug ) {
		global $proler__;
		$text = 'newrole' !== $page_slug ? __( 'Unlock all exclusive features with', 'product-role-rules' ) : __( 'Please upgrade to PRO to delete', 'product-role-rules' );
		?>
