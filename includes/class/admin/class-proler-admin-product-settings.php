...
class Proler_Admin_Product_Settings {
	...
	/**
	 * Init product specific settings
	 */
	...
	/**
	 * Display settings tab content on product page
	 */
	...
	/**
	 * Display settings tab header content
	 */
	...
	/**
	 * Display settings type on product edit page
	 */
	...
	/**
	 * Display role sttings content on product edit page
	 */
