...
if ( ! class_exists( 'ProlerAdminSettings' ) ) {
    class ProlerAdminSettings {
        ...
        public function show_notice(){
            ...
            $this->display_notice_msg( 'Settings saved successfully.' );

        }
        public function display_notice_msg( $msg ){
					...
					<div class="mpcdp_settings_option visible" data-field-id="footer_theme_customizer">
						<div class="mpcdp_settings_option_field_theme_customizer first_customizer_field">
							...
							<div class="mpcdp_settings_option_description">
								<div class="mpcdp_option_label"><?php echo wp_kses_post( $msg ); ?></div>
							</div>
						</div>
					</div>
				</div>
